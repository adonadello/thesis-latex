...
\begin{figure}[h]
  ...
  \definecolor{gridcolor}{RGB}{180, 180, 180} % Colore della griglia
  ...
  \begin{axis}[
      ...
      ytick=data,
      nodes near coords,
      nodes near coords align={horizontal}, % Orientamento orizzontale per le etichette
      xbar,
      bar width=15pt,
      xmin=0, xmax=100, % Imposta il range dell'asse x
      enlarge y limits=0.15, % Aumenta lo spazio tra le barre e i bordi dell'asse y
      legend style={at={(0.5,-0.15)}, anchor=north, legend columns=-1, draw=none}, % Elimina la cornice della legenda
      xmajorgrids=true, ymajorgrids=true, % Aggiunge griglia verticale e orizzontale
      grid style={line width=0.5pt, draw=gridcolor}, % Stile più sottile per la griglia
      axis line style={draw=none}, % Elimina la riga orizzontale interna
