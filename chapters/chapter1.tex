...
\subsubsection[Passaggio di messaggi]{Passaggio di messaggi}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width = 0.5\textwidth]{akka_messages.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width = 0.4\textwidth]{actor_lifecycle.png}
